...
export default function Header() {
  ...
  const { isAuthenticated, logout, userType } = useAuth(); // Added userType to determine redirection

  const dashboardPath = userType === 'host' ? '/host-dashboard' : '/client-dashboard'; // Determine dashboard path based on user type
              ...
              {isAuthenticated ? (
                <>
                  ...
                  >
                    <AnimatedButton
                      component={Link}
                      to={dashboardPath} // Use the determined dashboard path
                  ...
                  >
                    <AnimatedButton
                      onClick={logout}
                      variant={trigger ? "outlined" : "outlined"}
                      color={trigger ? "error" : "inherit"}
                      sx={{
                        color: trigger ? theme.palette.error.main : 'common.white',
                        borderColor: trigger ? theme.palette.error.main : 'rgba(255,255,255,0.3)',
                        px: 3,
                        py: 1,
                        borderRadius: 2,
                        fontWeight: 600,
                        whiteSpace: 'nowrap',
                        '&:hover': {
                          borderColor: trigger ? theme.palette.error.dark : 'rgba(255,255,255,0.6)',
                          backgroundColor: trigger ? theme.palette.error.light : 'rgba(255,255,255,0.1)'
                        }
                      }}
                    >
                      Logout
