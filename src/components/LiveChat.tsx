...
import { Box, IconButton, Paper, TextField, Typography, Avatar, Badge } from '@mui/material';
...
export default function LiveChat() {
  ...
  return (
    <Box sx={{ position: 'fixed', bottom: 24, right: 24, zIndex: 1000 }}>
      {open ? (
        <Paper elevation={10} sx={{ width: 320, height: 400, display: 'flex', flexDirection: 'column' }}>
          <Box sx={{ 
